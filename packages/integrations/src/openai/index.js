...
export class OpenAIClient {
  ...
  async transcribeAudio(audioBuffer) {
    ...
    try {
      ...
      console.error('[transcribeAudio] Error during processing:', error.message);
      console.error('[transcribeAudio] Stack trace:', error.stack);
      throw error;
      ...
      if (existsSync(tempFilePath)) {
        try {
          ...
          console.warn(`[transcribeAudio] Failed to cleanup temporary file: ${cleanupError.message}`);
        }
      }
    }
  }
